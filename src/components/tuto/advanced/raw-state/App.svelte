<script lang="ts">
  import { poll, scale, getTicks } from "./";
...
<div class="h-48 outer">
  <svg width={w} height={h / 4} bind:clientWidth={w} bind:clientHeight={h}>
    <line y1={h} y2={h} x2={w} />
    ...
    <text x={10} y={10} font-size={36}
      >state.raw() used because no need deep interactivity</text
    >
  </svg>
</div>
